...
TSharedPtr< FSlateStyleSet > FStandaloneWindowStyle::StyleInstance = NULL;
...
TSharedRef< FSlateStyleSet > FStandaloneWindowStyle::Create()
{
	...
	Style->Set("StandaloneWindow.OpenPluginWindow", new IMAGE_BRUSH(TEXT("ButtonIcon_40x"), Icon40x40));
