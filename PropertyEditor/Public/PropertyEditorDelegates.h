...
DECLARE_DELEGATE_RetVal_ThreeParams( TSharedRef< class SWidget >, FConstructExternalColumnCell,
	const FName& /*ColumnName*/, const TSharedRef< class IPropertyTreeRow >& /*RowWidget*/, TWeakPtr< class FPropertyNode>  )
